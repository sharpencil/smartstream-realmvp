...
export function MyFlowDashboard() {
  ...
  return (
    <div className="flex flex-col w-full bg-transparent relative">
      {/* Header */}
      <div className="sticky top-0 z-[120] bg-white/80 dark:bg-slate-950/95 backdrop-blur-md px-8 pt-8 pb-6 border-b border-slate-200 dark:border-slate-200 dark:border-white/5 flex items-center justify-between">
