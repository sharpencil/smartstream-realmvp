...
export const DailyBriefing = memo(({
  blockerCount,
  forecastSlipHours,
  forecastSlipStream,
  isAgentOpen,
        ...
        <div className="flex gap-2.5 mb-2.5">
          <div className="flex flex-col gap-2.5 w-full">
            <div className="flex gap-2.5 w-full items-stretch">
              ...
              <div className="flex-[2.5] bg-card border border-border dark:border-indigo-500/10 rounded-2xl px-4 py-3 h-24 flex flex-col justify-center relative overflow-hidden group shadow-arctic dark:shadow-[inset_0_0_40px_rgba(99,102,241,0.05)]">
                ...
                <p className="text-[12px] text-foreground font-medium leading-relaxed max-w-4xl line-clamp-2">
            ...
            <div className="w-full bg-card rounded-2xl border border-border flex flex-col sm:flex-row overflow-hidden shadow-arctic dark:shadow-[inset_0_0_20px_rgba(255,255,255,0.02)]">
              {/* Throughput */}
              <div className="flex-1 p-4 border-b sm:border-b-0 sm:border-r border-border flex flex-col justify-center group hover:bg-muted relative cursor-pointer gap-1.5">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Throughput · 7D</span>
                  <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest flex items-center gap-1 opacity-0 group-hover:opacity-100">Open <ArrowRight className="w-3 h-3" /></span>
                </div>
                <div className="flex items-baseline justify-between">
              ...
              <div
                ...
                className="flex-1 p-4 border-b sm:border-b-0 sm:border-r border-border flex flex-col justify-center group hover:bg-muted relative cursor-pointer gap-1.5"
              >
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Capacity Used</span>
                  <span className="text-[10px] font-bold text-amber-600/70 uppercase tracking-widest flex items-center gap-1 opacity-0 group-hover:opacity-100">Open <ArrowRight className="w-3 h-3" /></span>
                </div>
                <div className="flex items-baseline justify-between">
              ...
              {/* Forecast Stability */}
              <div className="flex-1 p-4 flex flex-col justify-center group hover:bg-muted relative cursor-pointer gap-1.5">
                <div className="flex items-center justify-between">
...
DailyBriefing.displayName = 'DailyBriefing';
