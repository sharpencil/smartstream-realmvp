  ...
  return (
    <div className="w-full flex flex-col transition-all duration-500 ease-in-out bg-transparent text-foreground pb-20">
      ...
      <div className="flex items-center justify-between px-8 pt-8 pb-6 border-b border-border dark:border-white/5 sticky top-0 bg-background/80 dark:bg-slate-950/95 dark:backdrop-blur-md z-40 shrink-0">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-2 p-1 bg-slate-100/80 dark:bg-slate-900/60 border border-black/[0.03] dark:border-slate-800/60 rounded-full dark:shadow-inner dark:shadow-black/20 h-auto">
          {[
            { id: 'crew', label: 'The Crew', ref: null },
            { id: 'bench', label: 'The Bench', ref: benchTabRef }
          ].map((tab) => {
